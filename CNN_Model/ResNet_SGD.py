...
if __name__ == '__main__':
    ...
    # set callback
    cbks = [TensorBoard(log_dir='drive/MyDrive/Model/ResNet/logs', histogram_freq=0),
            LearningRateScheduler(learningrate_scheduler),
            ModelCheckpoint('drive/MyDrive/Model/ResNet/logs', mode='auto', save_freq='epoch')]
    ...
    # start training
    resnet.fit(data_generator.flow(x_train, y_train, batch_size=batch_size),
                         steps_per_epoch=iterations,
                         epochs=epochs,
                         callbacks=cbks,
                         validation_data=(x_test, y_test))
    resnet.save('drive/MyDrive/Model/ResNet/model/resnet.tf')